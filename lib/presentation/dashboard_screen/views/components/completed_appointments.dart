  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SizedBox(
          ...
          child: widget.completedAppointments.isEmpty
              ? const Center(
                  child: Text('No appointments has been updated today'),
                )
              : ListView.builder(
                          ...
                          child: Row(
                            ...
                            children: [
                              SizedBox(
                                ...
                                child: widget.completedAppointments[index]
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        ...
                                        style:
                                            AppStyle.txtInterRegular14Gray700,
                                      ),
                                      const SizedBox(
                                        height: 5,
                                      ),
